...
class DatePicker {
  ...
  /// Display date&time picker bottom sheet.
  ///
  static void showYearOrMouthOrDayPicker(
    BuildContext context, {
    bool showTitleActions: true,
    DateTime minTime,
    DateTime maxTime,
...
enum DateType { YEAR, YEAR_MOUTH, YEAR_MOUTH_DAY }
...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    pickerModel,
    this.dateType = DateType.YEAR_MOUTH_DAY,
...
class _DatePickerState extends State<_DatePickerComponent> {
  ...
  void refreshScrollOffset() {
    if (this.widget.dateType == DateType.YEAR_MOUTH_DAY) {
    ...
    if (this.widget.dateType == DateType.YEAR_MOUTH) {
      leftScrollCtrl = new FixedExtentScrollController(
          initialItem: widget.pickerModel.currentLeftIndex());
      middleScrollCtrl = new FixedExtentScrollController(
          initialItem: widget.pickerModel.currentMiddleIndex());
    }
    if (this.widget.dateType == DateType.YEAR) {
      leftScrollCtrl = new FixedExtentScrollController(
          initialItem: widget.pickerModel.currentLeftIndex());
    }
  }
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          (this.widget.dateType == DateType.YEAR_MOUTH||this.widget.dateType == DateType.YEAR_MOUTH_DAY)
              ? _renderColumnView(
                  ValueKey(widget.pickerModel.currentLeftIndex()),
                  theme,
          ...
          this.widget.dateType == DateType.YEAR_MOUTH_DAY
              ? _renderColumnView(
